//
// Bullet physics <-> aurora render bridge module.
//
...
namespace sky::phy {
    ...
    class BulletPhysicsAuroraModule : public IModule {
    public:
        BulletPhysicsAuroraModule()           = default;
        ~BulletPhysicsAuroraModule() override = default;
...
REGISTER_MODULE(sky::phy::BulletPhysicsAuroraModule)
