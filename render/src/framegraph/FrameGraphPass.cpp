...
namespace sky {
    ...
    {
        switch (flag) {
        case ImageBindFlag::UNDEFINED: return VK_IMAGE_LAYOUT_UNDEFINED;
        case ImageBindFlag::COLOR:
        case ImageBindFlag::COLOR_RESOLVE:
        case ImageBindFlag::INPUT: return VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;
        case ImageBindFlag::DEPTH_STENCIL: return VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
        case ImageBindFlag::DEPTH_STENCIL_READ: return VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL;
        case ImageBindFlag::SHADER_READ: return VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
        case ImageBindFlag::PRESENT: return VK_IMAGE_LAYOUT_PRESENT_SRC_KHR;
        default: break;
        }
