...
namespace sky {
    ...
    {
        particleSystem.vertexInput = vk::VertexInput::Builder().Begin()
    ...
    void VulkanMemoryAliasing::SetupDescriptorSet()
    {
...

        {
            vk::DescriptorSetLayout::Descriptor setLayoutInfo = {};
            setLayoutInfo.bindings.emplace(0, vk::DescriptorSetLayout::SetBinding{VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1, VK_SHADER_STAGE_FRAGMENT_BIT});
            setLayoutInfo.bindings.emplace(1, vk::DescriptorSetLayout::SetBinding{VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1, VK_SHADER_STAGE_FRAGMENT_BIT});
