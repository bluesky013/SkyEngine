...
namespace sky {
    ...
    void VulkanMultiViewSample::OnStart()
    {
    ...
    void VulkanMultiViewSample::OnStop()
    {
        device->WaitIdle();
        pso            = nullptr;
    ...
    void VulkanMultiViewSample::OnTick(float delta)
    {
    ...
    void VulkanMultiViewSample::InitFeature()
    {
        deviceInfo.feature.multiView = true;
    }
} // namespace sky
