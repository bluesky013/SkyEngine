...
namespace sky::vk {
    ...
    std::unordered_map<rhi::Format, VkFormat> FORMAT_TABLE = {
        ...
        {rhi::Format::U_R8,      VK_FORMAT_R8_UINT},
        {rhi::Format::U_RG8,     VK_FORMAT_R8G8_UINT},
        {rhi::Format::U_RGB8,    VK_FORMAT_R8G8B8_UINT},
        {rhi::Format::U_RGBA8,   VK_FORMAT_R8G8B8A8_UINT},
        {rhi::Format::U_R16,     VK_FORMAT_R16_UINT},
        {rhi::Format::U_RG16,    VK_FORMAT_R16G16_UINT},
        {rhi::Format::U_RGB16,   VK_FORMAT_R16G16B16_UINT},
        {rhi::Format::U_RGBA16,  VK_FORMAT_R16G16B16A16_UINT},
        {rhi::Format::U_R32,     VK_FORMAT_R32_UINT},
        {rhi::Format::U_RG32,    VK_FORMAT_R32G32_UINT},
        {rhi::Format::U_RGB32,   VK_FORMAT_R32G32B32_UINT},
        {rhi::Format::U_RGBA32,  VK_FORMAT_R32G32B32A32_UINT},
    };
