# aurora-skinning Specification

## Purpose

Define Aurora's mesh-side skinning types and naming contract. Animation is an independent module (`engine/animation`, target `Animation`); Aurora defines no skeleton type and maps animation into a self-contained `Skin`.
