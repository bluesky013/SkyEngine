...
Define the headless UI document editing model: mutating the element tree, serializing to the UI document
format, and undo/redo. A visual shell is a separate concern that depends on the render pass.
