...
foreach(lib ${BOOST_LIB_NAMES})
    set(${LIB_NAME}_LIBRARY_DEBUG ${${LIB_NAME}_LIBRARY_DEBUG}
            ${${LIB_NAME}_LIBS_DIR}/Debug/${CMAKE_STATIC_LIBRARY_PREFIX}boost_${lib}${CMAKE_STATIC_LIBRARY_SUFFIX})

    set(${LIB_NAME}_LIBRARY_RELEASE ${${LIB_NAME}_LIBRARY_RELEASE}
            ${${LIB_NAME}_LIBS_DIR}/Release/${CMAKE_STATIC_LIBRARY_PREFIX}boost_${lib}${CMAKE_STATIC_LIBRARY_SUFFIX})
endforeach()
