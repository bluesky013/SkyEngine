...
if (APPLE)
	set(${LIB_NAME}_LIBRARY_DEBUG
		${${LIB_NAME}_LIBS_DIR}/Debug/libktx.dylib)

	set(${LIB_NAME}_LIBRARY_RELEASE
		${${LIB_NAME}_LIBS_DIR}/Release/libktx.dylib)
else()
	set(${LIB_NAME}_LIBRARY_DEBUG
		${${LIB_NAME}_LIBS_DIR}/Debug/${CMAKE_STATIC_LIBRARY_PREFIX}ktx${CMAKE_STATIC_LIBRARY_SUFFIX})

	set(${LIB_NAME}_LIBRARY_RELEASE
		${${LIB_NAME}_LIBS_DIR}/Release/${CMAKE_STATIC_LIBRARY_PREFIX}ktx${CMAKE_STATIC_LIBRARY_SUFFIX})
endif()
